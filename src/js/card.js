          ...
          (a = function () {
            ...
            class t {
              ...
              constructor(r) {
                ...
                (this.maskCVC = this.maskCVC.bind(this)),
              ...
              attachHandlers() {
                ...
                return (
                  ...
                  n.on(
                    this.$numberInput,
                    "payment.cardType",
                    this.handle("setCardType", "payment.cardType")
                  ),
                  (e = [
                    function (r) {
                  ...
                  (t = [this.validToggler("cardCVC")]),
                  this.options.masks.cvcInput && t.push(this.maskCVC),
                  console.log(t),
            ...
            return (
              ...
              (t.prototype.defaults = {
                ...
                masks: { cardNumber: !1, cvcInput: !1 },
                classes: { valid: "jp-card-valid", invalid: "jp-card-invalid" },
                debug: !1,
              }),
              (t.prototype.handlers = {
                setCardType: function (r, e, v) {
                  let cardtype = Payment.fns.cardType(this.$numberInput[0].value)
                  console.log("should be changing css", v);
                  console.log(this[v])
                  var t, a;
                  if (
                    ((t = e.data),
                    ...
                    return (
                      ...
                      n.addClass(this.$card, `jp-card-${cardtype}`),
                      n.toggleClass(
                        this.$card,
                        "jp-card-identified",
                        "unknown" !== t
